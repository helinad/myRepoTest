...
public class ChartViewControl  extends View implements ChartChangeListener,
ChartProgressListener {

/** The user interface thread handler. */
private Handler mHandler;

public ChartViewControl(Context context) {
super(context);
mHandler = new Handler();
this.initialize();
}

public ChartViewControl(Context context, AttributeSet attrs) {
super(context, attrs);
mHandler = new Handler();
this.initialize();
}
