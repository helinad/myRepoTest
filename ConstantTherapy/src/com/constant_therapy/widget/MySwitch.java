...
public class MySwitch extends CompoundButton {
    ...
    public MySwitch(Context context, AttributeSet attrs, int defStyle) {
        ...
        Log.d(TAG, "mSwitchMinWidth=" + mSwitchMinWidth);
    ...
    public void isOnorOff(boolean onOrOff) {
    ...
    private Layout makeLayout(CharSequence text) {
        return new StaticLayout(text, mTextPaint,
                (int) android.util.FloatMath.ceil(Layout.getDesiredWidth(text, mTextPaint))*2,
    ...
    */
    ...
    public void setSwitchMinWidth(int minWidth) {
    	
    	this.mSwitchMinWidth = minWidth;
    	requestLayout();
    }
    
public void setSwitchMinHeight(int minHeight) {
    	
    	this.mSwitchMinHeight = minHeight;
    	requestLayout();
    }
