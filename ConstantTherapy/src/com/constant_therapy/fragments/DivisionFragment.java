...
public class DivisionFragment extends Fragment implements OnClickListener{
	...
	onCheckDivisionAnswerClickListener mCallback;

    // The container Activity must implement this interface so the frag can deliver messages
    public interface onCheckDivisionAnswerClickListener {
	...
	public static DivisionFragment newInstance(String choice, String symbol) {
		DivisionFragment fragmentDemo = new DivisionFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.division_frame, null, false);
	...
	public void onAttach(Activity activity) {
		...
		try {
            mCallback = (onCheckDivisionAnswerClickListener) activity;
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		mCallback.onCheckDivisionAnswerClick(v, answer.getText().toString());
