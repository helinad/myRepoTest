...
public class NLevelAdapter extends BaseAdapter { 
	...
	public TasksHierarchy getSelectedItem(int arg0) {
		return filtered.get(arg0).getWrappedObject();
	}
	
	public View getSelectedView(int arg0) {
		return filtered.get(arg0).getView();
	}
