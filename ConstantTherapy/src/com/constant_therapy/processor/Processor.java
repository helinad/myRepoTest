...
public abstract class Processor {
	 ...
	 */
	public void parseAndApply(String parser, ContentResolver resolver) throws ProcessorException {
		try {
	 ...
	 */
	public abstract ArrayList<ContentProviderOperation> parse(String parser,
